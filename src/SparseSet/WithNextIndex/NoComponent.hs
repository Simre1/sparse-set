...
-- | The sparse set contains a sparse array and a dense array.
-- The sparse set is useful when you have a lot of possible keys but not that many key
-- to actually store. Iteration over the keys is very quick.
